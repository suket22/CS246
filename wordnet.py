...
def heuristic_synscore(questionText1, questionText2, info_content_norm):
...
def fire_wordnet_sim(data, rawSamples, keyToIndex, filenametrue, filenamefalse):
...
fire_wordnet_sim(data, rawSamples, data.keyToIndex, "wordnet_true.out", "wordnet_false.out")


print('----------Accuracy with normalized-----------------')
test_accuracy('wordnet_true.out')

print('----------Accuracy without normalized-----------------')
test_accuracy('wordnet_false.out')